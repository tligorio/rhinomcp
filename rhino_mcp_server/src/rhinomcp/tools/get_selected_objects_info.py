...
@mcp.tool()
async def get_selected_objects_info(ctx: Context, include_attributes: bool = False) -> str:
    ...
    try:
        ...
        result = await rhino.send_command("get_selected_objects_info", {"include_attributes": include_attributes})
